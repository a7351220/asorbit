...
const nfts: NFT[] = [
  ...
  { id: 2, name: 'WJSN Bona - As You Wish #696969', group: 'WJSN', image: '/nft-images/winter.png' },
  // ... 其他 NFT
];
                ...
                <div key={nft.id} className="border border-gray-300 rounded-lg overflow-hidden cursor-pointer" onClick={() => handleNFTClick(nft)}>
                  ...
                  <div className="p-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Image src={`/group-logos/${nft.group.toLowerCase()}.png`} alt={nft.group} width={20} height={20} />
                    </div>
